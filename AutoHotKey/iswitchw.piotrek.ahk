...
filterlist = asticky|blackbox|explorer
...
; 
;CapsLock::
;; not sure why but this conflicts with KeyboardHooks and the form is closed as soon as a release LAlt+Space (precisely LAlt)
;<!Space:: 
;; not sure why but this conflicts is solved with this tiny change (I don't have AHK debugging skills so I'll leave it this way)
!Space::
